...
let apiLink =
  "https://v6.exchangerate-api.com/v6/3cee310aa784eefc20408ba0/latest/USD"; ///using api to get exchange rates of different currencies.
// console.log(apiLink) //it will give the link

// we have to fetch data from the url:

let fetching = async (data: any) => {
